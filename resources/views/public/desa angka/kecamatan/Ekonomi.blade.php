<div class="bg-gray-50 p-6 rounded-lg shadow-md">
    ...
    <h3 class="text-xl font-bold mb-4 text-center">Jumlah Warung Tradisional, Toko Modern dan Industri Berdasarkan Desa di Kecamatan {{ $kecamatanName }} - Tahun {{ $tahun }}</h3>
