<div class="bg-gray-50 p-6 rounded-lg shadow-md">
    ...
    <h3 class="text-xl font-bold mb-4 text-center">Jumlah Sarana Pendidikan Berdasarkan di Desa {{ $desaName }} kecamatan {{ $kecamatanName }}, Tahun {{ $tahun }}</h3>
        ...
        <table class="min-w-full bg-white border-collapse">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="py-3 px-4 border-b text-center" colspan="7">Sarana Pendidikan</th>
                </tr>
                <tr class="bg-gray-100">
                    <th class="py-3 px-4 border-b text-center">Perpustakaan</th>
                    <th class="py-3 px-4 border-b text-center">PAUD/KB</th>
                    <th class="py-3 px-4 border-b text-center">TK/RA/BA</th>
                    <th class="py-3 px-4 border-b text-center">SD/MI</th>
                    <th class="py-3 px-4 border-b text-center">SMP/Mts</th>
                    <th class="py-3 px-4 border-b text-center">SMA/SMK/MA</th>
                    <th class="py-3 px-4 border-b text-center">Perguruan Tinggi</th>
                </tr>
            </thead>
            <tbody>
