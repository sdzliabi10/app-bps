<div class="bg-gray-50 p-6 rounded-lg shadow-md">
    ...
    <h3 class="text-xl font-bold mb-4 text-center">Jumlah Jenis Usaha Menurut Sektor Lapangan Berdasarkan di Desa {{ $desaName }} Kecamatan {{ $kecamatanName }}, Tahun {{ $tahun }}</h3>
        ...
        <table class="min-w-full bg-white border-collapse">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="py-3 px-4 border-b text-center" colspan="5">Jenis Usaha</th>
                </tr>
                <tr class="bg-gray-100">
                    <th class="py-3 px-4 border-b text-center">Tanaman Pangan</th>
                    <th class="py-3 px-4 border-b text-center">Hortikultura</th>
            ...
            <tfoot>
                <tr class="bg-gray-100">
                    ...
                    <td class="py-3 px-4 border-b font-semibold text-center">15</td>
                    <td class="py-3 px-4 border-b font-semibold text-center">11</td>
