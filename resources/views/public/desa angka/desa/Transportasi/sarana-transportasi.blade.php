<div class="bg-gray-50 p-6 rounded-lg shadow-md">
    ...
    <h3 class="text-xl font-bold mb-4 text-center">Jumlah Trayek yang Melintas Berdasarkan di Desa {{ $desaName }} Kecamatan {{ $kecamatanName }}, Tahun {{ $tahun }}</h3>
        ...
        <table class="min-w-full bg-white border-collapse">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="py-3 px-4 border-b text-center">Angkutan Desa (Angkudes)</th>
                    <th class="py-3 px-4 border-b text-center">Angkutan Antar Kota Dalam Provinsi (AKDP)</th>
                    <th class="py-3 px-4 border-b text-center">Angkutan Antar Kota Antar Provinsi (AKAP)</th>
                </tr>
            </thead>
            <tbody>
