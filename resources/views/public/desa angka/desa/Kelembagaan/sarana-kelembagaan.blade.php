<div class="bg-gray-50 p-6 rounded-lg shadow-md">
    ...
    <h3 class="text-xl font-bold mb-4 text-center">Kelembagaan Berdasarkan di Desa {{ $desaName }} Kecamatan {{ $kecamatanName }}, Tahun {{ $tahun }}</h3>
        ...
        <table class="min-w-full bg-white border-collapse">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="py-3 px-4 border-b text-center">RT</th>
                    <th class="py-3 px-4 border-b text-center">RW</th>
                    <th class="py-3 px-4 border-b text-center">Kelompok Tani</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
                <tr class="bg-gray-100">
                    ...
                    <td class="py-3 px-4 border-b font-semibold text-center">24</td>
