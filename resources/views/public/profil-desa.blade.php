                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">
                                <button onclick="openModal('LPMD')" class="bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600 transition duration-300">Lihat
                                    Detail</button>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200 text-sm text-gray-700">20</td>
                            <td class="py-2 px-4 border-b border-gray-200">
                                <button onclick="openModal('PKK')" class="bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600 transition duration-300">Lihat
                                    Detail</button>
                            </td>
                        </tr>
                        <tr>
