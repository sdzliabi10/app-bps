    ...
    <div id="desa-content" class="{{ request('kecamatan') || request('desa') ? '' : 'hidden' }}">
        ...
        <div id="perangkat-desa" class="content-section hidden mt-6">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-200">
                                        <button onclick="openModal('modal-kelembagaan')"
                ...
                <div id="modal-kelembagaan"
                    ...
                    <div class="bg-white rounded-lg w-full max-w-md overflow-hidden shadow-xl transform transition-all">
                        <div class="flex justify-between items-center bg-blue-500 text-white p-4">
                            ...
                            <button onclick="closeModal('modal-kelembagaan')"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-gray-300 p-2">
                                <button
                                    onclick="openModal('modal-infrastruktur', 'Total jembatan di desa ini adalah 12 unit.')"
                                    class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Lihat
                                    Detail</button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="border border-gray-300 p-2">
                                <button
                                    onclick="openModal('modal-infrastruktur', 'Informasi detail tentang tempat pembuangan sampah belum tersedia.')"
                                    class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Lihat
                                    Detail</button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="border border-gray-300 p-2">
                                <button onclick="openModal('modal-infrastruktur')"
                                    class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Lihat
                                    Detail</button>
                            </td>
                        </tr>
            ...
            <table class="mt-6 w-full border-collapse border border-gray-300">
                ...
                <!-- Modal -->
                <div id="modal-infrastruktur"
                    class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center p-4 z-50 hidden">
                    <div class="bg-white rounded-lg w-full max-w-md overflow-hidden shadow-xl transform transition-all">
                        <div class="flex justify-between items-center bg-blue-500 text-white p-4">
                            <h3 class="text-xl font-semibold">Detail Data</h3>
                            <button onclick="closeModal('modal-infrastruktur')"
                                class="text-white hover:text-gray-200 text-2xl">&times;</button>
                        </div>
                        <div id="modal-content" class="p-6">
                            <!-- Konten modal -->
