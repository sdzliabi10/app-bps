...
@section('title', 'Edit Data Jalan Desa')

@section('content')
    <main>
        <div class="container-xl px-4 mt-4">
            <div class="card mb-4">
                <div class="card-header">Edit Data Jalan Desa</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('jalan-desa.update', $jalanDesa->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_jalan" id="nama_jalan" 
                                value="{{ old('nama_jalan', $jalanDesa->nama_jalan) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="kondisi" id="kondisi" required>
                                ...
                                <option value="Baik" {{ old('kondisi', $jalanDesa->kondisi) == 'Baik' ? 'selected' : '' }}>Baik</option>
                                <option value="Rusak Ringan" {{ old('kondisi', $jalanDesa->kondisi) == 'Rusak Ringan' ? 'selected' : '' }}>Rusak Ringan</option>
                                <option value="Rusak Berat" {{ old('kondisi', $jalanDesa->kondisi) == 'Rusak Berat' ? 'selected' : '' }}>Rusak Berat</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="jenis" id="jenis" required>
                                ...
                                <option value="Aspal" {{ old('jenis', $jalanDesa->jenis) == 'Aspal' ? 'selected' : '' }}>Aspal</option>
                                <option value="Beton" {{ old('jenis', $jalanDesa->jenis) == 'Beton' ? 'selected' : '' }}>Beton</option>
                                <option value="Makadam" {{ old('jenis', $jalanDesa->jenis) == 'Makadam' ? 'selected' : '' }}>Makadam</option>
                                <option value="Tanah" {{ old('jenis', $jalanDesa->jenis) == 'Tanah' ? 'selected' : '' }}>Tanah</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi</label>
                            <textarea class="form-control" name="lokasi" id="lokasi" required>{{ old('lokasi', $jalanDesa->lokasi) }}</textarea>
                        </div>
