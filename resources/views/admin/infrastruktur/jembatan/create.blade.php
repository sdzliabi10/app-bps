...
@section('content')
    <main>
        <div class="container-xl px-4 mt-4">
            <div class="card mb-4">
                <div class="card-header">Tambah Data Jembatan</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('jembatan.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_jembatan" id="nama_jembatan" 
                                value="{{ old('nama_jembatan') }}" required>
                        </div>
    ...
    <script>
        function filterDesa() {
            ...
            var desaOptions = document.querySelectorAll('#iddesa option');
            ...
            document.getElementById('iddesa').value = '';
        }
