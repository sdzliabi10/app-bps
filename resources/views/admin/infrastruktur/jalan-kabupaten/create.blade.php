...
@section('title', 'Tambah Data Jalan Kabupaten')

@section('content')
    <main>
        <div class="container-xl px-4 mt-4">
            <div class="card mb-4">
                <div class="card-header">Tambah Data Jalan Kabupaten</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('jalan-kabupaten.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
