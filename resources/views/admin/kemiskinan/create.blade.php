...
@section('title', 'Tambah Data Kemiskinan')

@section('content')
    <main>
        <div class="container-xl px-4 mt-4">
            <div class="card mb-4">
                <div class="card-header">Tambah Data Kemiskinan</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('kemiskinan.store') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_penerima" name="jumlah_penerima" 
                                value="{{ old('jumlah_penerima') }}" required min="0">
