    ...
    <div id="desa-content" class="{{ request('kecamatan') || request('desa') || request('tahun') ? '' : 'hidden' }}">
        ...
        <div id="profil-desa" class="content-section flex flex-col md:flex-row items-center bg-white shadow-md rounded-lg p-6 border border-gray-200 mt-6">
            ...
            <div class="md:w-1/3 w-full">
                <img src="desa.jpg" alt="Profil Desa" class="w-full h-auto rounded-lg shadow-md">
            </div>
            ...
            <div class="md:w-2/3 w-full md:pl-6 mt-4 md:mt-0">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-600">Menjadikan desa yang maju, sejahtera, dan berkelanjutan dengan mengedepankan kearifan lokal.</p>
                </div>

                <div class="mb-4">
                    <h3 class="text-xl font-semibold text-gray-700">Misi</h3>
                    <ul class="list-disc list-inside text-gray-600">
                        <li>Meningkatkan perekonomian desa berbasis UMKM.</li>
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-disc list-inside text-gray-600">
                        ...
                        <li>Pelatihan keterampilan bagi pemuda desa.</li>
                        <li>Peningkatan fasilitas kesehatan desa.</li>
                        <li>Revitalisasi ruang hijau dan wisata desa.</li>
                    </ul>
                </div>

                <div class="mb-4">
                    <h3 class="text-xl font-semibold text-gray-700">Batas Wilayah</h3>
                    <p class="text-gray-600">Utara: Desa A | Selatan: Desa B | Timur: Desa C | Barat: Desa D</p>
                </div>

                <div class="mb-4">
                    <h3 class="text-xl font-semibold text-gray-700">Kontak</h3>
                    <p class="text-gray-600"><strong>Alamat:</strong> Jl. Raya Desa No. 123, Kecamatan X, Kabupaten Y</p>
                    <p class="text-gray-600"><strong>Telepon:</strong> (021) 12345678</p>
                </div>
            </div>
        </div>
            ...
            <div class="relative bg-gray-100 p-6 rounded-lg shadow-md">
                ...
                <div class="overflow-x-auto scroll-smooth scrollbar-hide p-2">
                    <div class="flex space-x-4 md:grid md:grid-cols-3 lg:grid-cols-4 md:gap-6">
                        ...
                        <p class="text-gray-500 mt-4 text-center w-full">Belum ada data perangkat desa. Silakan tambahkan melalui panel admin.</p>
                        @else
                        @foreach ($perangkat as $p)
                        <div class="min-w-[250px] md:w-full bg-white shadow-md rounded-xl overflow-hidden p-4">
                            <div class="bg-gray-100 rounded-lg overflow-hidden">
                                <img src="{{ asset('images/' . $p['foto']) }}" alt="{{ $p['nama'] }}" class="w-full h-56 object-cover">
                            </div>
                            <div class="p-4 text-center space-y-1">
                                <h3 class="text-lg font-bold text-gray-800 leading-tight">{{ $p['nama'] }}</h3>
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">{{ number_format($item['pendapatan'] ?? 0, 0, ',', '.') }}</td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="2" class="py-2 px-4 border-b text-center text-gray-500">Belum ada data pendapatan.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">{{ number_format($item['belanja'] ?? 0, 0, ',', '.') }}</td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="2" class="py-2 px-4 border-b text-center text-gray-500">Belum ada data belanja.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="relative p-6 rounded-lg shadow-md border">
                ...
                <div class="overflow-x-auto scroll-smooth scrollbar-hide p-2">
                    <div class="flex space-x-4 md:grid md:grid-cols-3 lg:grid-cols-4 md:gap-6">
                        ...
                        <p class="mt-4 text-center w-full">Belum ada data BPD. Silakan tambahkan melalui panel admin.</p>
                        @else
                        @foreach ($bpd as $b)
                        <div class="min-w-[250px] md:w-full bg-white shadow-lg rounded-xl overflow-hidden p-4 border">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">
                                <button onclick="openModal('LPMD')" class="bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600 transition duration-300">Lihat Detail</button>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200 text-sm text-gray-700">20</td>
                            <td class="py-2 px-4 border-b border-gray-200">
                                <button onclick="openModal('PKK')" class="bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600 transition duration-300">Lihat Detail</button>
                            </td>
                        </tr>
                        <tr>
                            <td class="py-2 px-4 border-b border-gray-200 text-sm text-gray-700">Jumlah Anggota</td>
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border border-gray-200 text-sm text-gray-700">BERGERAK DIBIDANG WISATA MAKANAN LOKAL JASA NOMOR ; AHU-04143.AH 01.33 TH 2022</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="bg-gray-50 px-6 py-4 flex justify-end">
                        <button onclick="closeModal()" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-300">Tutup</button>
                    </div>
                </div>
            </div>
